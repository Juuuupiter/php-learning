...
<div class="MainForm BlogArticleManage">
  <h3 class="title">共有 <?php echo $total ?> 篇博客，每页显示 40 个，共 1 页</h3>
    <div id="BlogOpts">
  ...
  <ul>
	  <?php foreach ($list as $list_article) {?>
	       <li class="row_1">
		  		<input name="blog" value="<?php echo $list_article->article_id ?>" type="checkbox">
		  		<a href="viewPost_comment.htm" target="_blank"><?php echo $list_article->title ?></a>
		  		<small><?php echo $list_article->post_date ?></small>
		  	</li>
	  <?php } ?>
	  </ul>
    </div>
