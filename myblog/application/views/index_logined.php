...
<div class="BlogList">
<ul>
	<?php foreach ($list as $list_article) {?>
		<li class='Blog' id='blog_24027'>

			<h2 class='BlogAccess_true BlogTop_0'><a href="viewPost_comment.htm"><?php echo $list_article->title ?></a></h2>

			<div class='outline'>

				<span class='time'><?php echo $list_article->post_date?></span>

				<span class='catalog'>分类: <a href="?catalog=92334"><?php echo $list_article->type_name ?></a></span>

				<span class='stat'>统计: 0评/<?php echo $list_article->clicked ?></span>

			</div>

			<div class='TextContent' id='blog_content_24027'>

				<?php echo $list_article->content?>
