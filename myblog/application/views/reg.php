...
<form id="frm_reg" action="user/add_user" onsubmit="return false" method="get" style="float:left; width:620px;">
...
<!--            <script language="javascript">function _rvi(){document.getElementById('img_vcode').src = '/action/user/captcha?t='+Math.random(1000);}</script>-->
    	...
    	<tr class="buttons">
    		...
    		<input id="btn-reg" value=" 注册新用户 " class="BUTTON SUBMIT" type="submit">
			</td>
    	</tr>
	</tbody></table>
</form>
